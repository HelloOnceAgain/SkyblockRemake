...
execute if score ItemCount CraftFilledSlots matches 2.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_2+"
execute if score ItemCount CraftFilledSlots matches 4.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_4+"
execute if score ItemCount CraftFilledSlots matches 5.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_5+"
execute if score ItemCount CraftFilledSlots matches 6.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_6+"
execute if score ItemCount CraftFilledSlots matches 8.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_8+"
...
execute if score ItemCount CraftFilledSlots matches 12.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_12+"
execute if score ItemCount CraftFilledSlots matches 16.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_16+"
execute if score ItemCount CraftFilledSlots matches 24.. run data modify storage blue:crafting Recipes[0].RecipeData[8].tag.RecipeTags append value "COUNT_24+"
